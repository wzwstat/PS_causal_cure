##===============================================================================
## PS_Beran Method in Table 1 and Table 2
##===============================================================================

###############################################################################
#  Running this script you will save the results for 
#  PS_Beran Method: ACE_est, SPCE_cure_est

#  The script by parallel for one setting may take ~1.2 hours to execute. 
...
#      (1) MSE_ACE_SPCEcure_weak_alp0_PE20_PSBeran.RData
#      (2) MSE_ACE_SPCEcure_weak_alp0_PE35_PSBeran.RData
#      (3) MSE_ACE_SPCEcure_weak_alp0_PE50_PSBeran.RData
#      (4) MSE_ACE_SPCEcure_weak_alp05_PE20_PSBeran.RData
#      (5) MSE_ACE_SPCEcure_weak_alp05_PE35_PSBeran.RData
#      (6) MSE_ACE_SPCEcure_weak_alp05_PE50_PSBeran.RData
#      (7) MSE_ACE_SPCEcure_weak_alp1_PE20_PSBeran.RData
#      (8) MSE_ACE_SPCEcure_weak_alp1_PE35_PSBeran.RData
#      (9) MSE_ACE_SPCEcure_weak_alp1_PE50_PSBeran.RData
#      ......
#  2.-Table 1 and Table 2 for strong association in the manuscript
#      (1) MSE_ACE_SPCEcure_strong_alp0_PE20_PSBeran.RData
#      (2) MSE_ACE_SPCEcure_strong_alp0_PE35_PSBeran.RData
#      (3) MSE_ACE_SPCEcure_strong_alp0_PE50_PSBeran.RData
#      (4) MSE_ACE_SPCEcure_strong_alp05_PE20_PSBeran.RData
#      (5) MSE_ACE_SPCEcure_strong_alp05_PE35_PSBeran.RData
#      (6) MSE_ACE_SPCEcure_strong_alp05_PE50_PSBeran.RData
#      (7) MSE_ACE_SPCEcure_strong_alp1_PE20_PSBeran.RData
#      (8) MSE_ACE_SPCEcure_strong_alp1_PE35_PSBeran.RData
#      (9) MSE_ACE_SPCEcure_strong_alp1_PE50_PSBeran.RData
#      ......
#
#  The saved results can be loaded with load(). 
#  Example: load("MSE_intermediate_results/weak/MSE_ACE_SPCEcure_weak_alp0_PE20_PSBeran.RData")
#  
...
#            In this script, change the values of alpha11_true and beta11_true in lines 144 - 190
# 
...
#save(MyRsult, file = "MSE_intermediate_results/weak/MSE_ACE_SPCEcure_weak_alp0_PE20_PSBeran.RData")
