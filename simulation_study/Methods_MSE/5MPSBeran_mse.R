##===============================================================================
## MPS_Beran Method in Table 1 and Table 2
##===============================================================================

###############################################################################
#  Running this script you will save the results for 
#  MPS_Beran Method: ACE_est, SPCE_cure_est

#  The script by parallel for one setting may take ~1.3 hours to execute. 
#  To save time, the results for both scenarios have been saved 
#  in the folder "MSE_intermediate_results/..":
#  1.-Table 1 and Table 2 for a weak association 
#      (1) MSE_ACE_SPCEcure_weak_alp0_PE20_MPSBeran.RData
#      (2) MSE_ACE_SPCEcure_weak_alp0_PE35_MPSBeran.RData
#      (3) MSE_ACE_SPCEcure_weak_alp0_PE50_MPSBeran.RData
#      (4) MSE_ACE_SPCEcure_weak_alp05_PE20_MPSBeran.RData
#      (5) MSE_ACE_SPCEcure_weak_alp05_PE35_MPSBeran.RData
#      (6) MSE_ACE_SPCEcure_weak_alp05_PE50_MPSBeran.RData
#      (7) MSE_ACE_SPCEcure_weak_alp1_PE20_MPSBeran.RData
#      (8) MSE_ACE_SPCEcure_weak_alp1_PE35_MPSBeran.RData
#      (9) MSE_ACE_SPCEcure_weak_alp1_PE50_MPSBeran.RData
#      ......
#  2.-Table 1 and Table 2 for a strong association
#      (1) MSE_ACE_SPCEcure_strong_alp0_PE20_MPSBeran.RData
#      (2) MSE_ACE_SPCEcure_strong_alp0_PE35_MPSBeran.RData
#      (3) MSE_ACE_SPCEcure_strong_alp0_PE50_MPSBeran.RData
#      (4) MSE_ACE_SPCEcure_strong_alp05_PE20_MPSBeran.RData
#      (5) MSE_ACE_SPCEcure_strong_alp05_PE35_MPSBeran.RData
#      (6) MSE_ACE_SPCEcure_strong_alp05_PE50_MPSBeran.RData
#      (7) MSE_ACE_SPCEcure_strong_alp1_PE20_MPSBeran.RData
#      (8) MSE_ACE_SPCEcure_strong_alp1_PE35_MPSBeran.RData
#      (9) MSE_ACE_SPCEcure_strong_alp1_PE50_MPSBeran.RData
#      ......
#
#  The saved results can be loaded with load(). 
#  Example: load("MSE_intermediate_results/weak/MSE_ACE_SPCEcure_weak_alp0_PE20_MPSBeran.RData")
#  
...
#            In this file, change the values of alpha11_true and beta11_true in lines 144 - 190
# 
...
Getace <- function (ii){
  ...
  # generate survival data
    data_ran <- getdata_MPS()
  # data_ran <- getdata()
   
  MPS_Beran <- function(data){
    ...
    for(j in 1:J){
      ...
      # DATA <- datastratify_probit(data)[[j]]
      DATA1 <- DATA[DATA$z == 1, ]
      DATA0 <- DATA[DATA$z == 0, ]
  ...
  summ_est <- MPS_Beran(data_ran)
  return(list(summ_est = summ_est))
}

######----------------------SET--------------------------------------------------
J <- 5    # number of stratification
...
#save(MyRsult, file = "MSE_intermediate_results/weak/MSE_ACE_SPCEcure_weak_alp0_PE20_MPSBeran.RData")
